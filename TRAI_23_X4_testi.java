 ...
 */
public class TRAI_23_X4_testi {

    static Random rnd = new Random();

    static TRAI_23_X4 testattava = new TRAI_23_X4_ksuurnie(); /* <-- Oma tunnus tÃ¤hÃ¤n */
    ...
    // TODO kommentit
    static <E extends Comparable<? super E>> boolean X4testiEsim(BTree<E> T, E x) {
     ...
     */
    static <E> void sisaTulosta(BTree<E> T) {
        sisaTulosta(T.getRoot());
        System.out.println();
    }


    static <E> void sisaTulosta(BTreeNode<E> n) {
        if (n == null)
            return;
     ...
     */
    public static <E> boolean samatTakaperin(List<E> A, List<E> B) {
        ListIterator<E> iA = A.listIterator();
        ListIterator<E> iB = B.listIterator(B.size());
        ...
        return !iA.hasNext() && !iB.hasPrevious();
    }
